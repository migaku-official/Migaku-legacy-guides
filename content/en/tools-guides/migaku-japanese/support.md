---
title: Migaku Japanese Support
shortTitle: Get Support
description: Get support for any issues you're having with the Migaku Japanese Add-on.
headerImage: /content-images/tools-guides/migaku-japanese/migaku-japanese-header.png
position: 3
---

# Migaku Japanese Support
...
We have created a detailed <internal-link to="/tools-guides/migaku-japanese/manual">User's Manual for Migaku Japanese</internal-link>. It is recommended that if you are having an issue with a specific feature in the add-on that you reference its relevant section in the User's Manual which may help to resolve your issue.
