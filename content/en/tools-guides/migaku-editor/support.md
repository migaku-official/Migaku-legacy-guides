---
title: Migaku Editor Support
shortTitle: Get Support
description: Get support for any issues you're having with the Migaku Editor Add-on.
headerImage: /content-images/tools-guides/migaku-editor/editor-header.png
position: 2
---

# Migaku Editor Support
...
We have created a detailed <internal-link to="/tools-guides/migaku-editor/guide">User's Guide for Migaku Editor</internal-link>. It is recommended that if you are having an issue with a specific feature in the add-on that you reference its relevant section in the User's Manual which may help to resolve your issue.
